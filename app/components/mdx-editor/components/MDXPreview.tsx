...
const MapWrapper = (props) => {
  try {
    ...
    let center;
    try {
      center = typeof props.center === 'string' && props.center.startsWith('[')
    ...
    return (
      <ClientMapBlock
        ...
        compareDateTime={props.compareDateTime || DEFAULT_MAP_PROPS.compareDateTime}
